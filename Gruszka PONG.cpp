					   ...
					   _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_GRUSZKAPONG, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_GRUSZKAPONG));
...
ATOM MyRegisterClass(HINSTANCE hInstance)        //Samo okno
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_GRUSZKAPONG));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(CreateSolidBrush(RGB(255,255,255)));
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_GRUSZKAPONG);
